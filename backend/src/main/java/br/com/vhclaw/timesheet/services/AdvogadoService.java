...
public class AdvogadoService {
    ...
    @Transactional(readOnly = true)
    public List<TimeSheet> findTimeSheetAdvId(Long id) {
        Optional<Advogado> advogadoDTO = repository.findById(id);
        List<TimeSheet> lista = advogadoDTO.get().getTimeSheets();
