...
public class AdvogadoResource {
	...
	@GetMapping(value = "/get-time-sheet/{id}")
	public ResponseEntity<List<TimeSheet>> getAllTimeSheet(@PathVariable Long id){
		List<TimeSheet> lista = service.findTimeSheetAdvId(id);
