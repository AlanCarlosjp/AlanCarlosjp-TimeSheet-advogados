...
public class TimeSheetResource {
	...
	@GetMapping(value = "/nome/{nome}/date/{date}")
	public ResponseEntity<List<TimeSheet>> findByNameOurDate(Long id, String dti){
		List<TimeSheet> lista = service.findByNameOurDate(id, dti);
